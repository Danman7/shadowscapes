      ...
      <div className="relative">
        {count > 0 ? (
          <>
            ...
            <div className="absolute -bottom-2 -right-2 bg-gray-800 text-white text-xs font-bold rounded-full w-6 h-6 flex items-center justify-center" data-testid="deck-count">
              {count}
            </div>
          </>
        ) : (
          <div className="text-gray-400 italic text-sm" data-testid="deck-empty">
            Empty
          </div>
        )}
      </div>
