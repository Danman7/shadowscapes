...
export const Card: React.FC<{
  ...
  return (
    <div
      className={`card flex flex-col ${factionBorderColor} border-8 ${isOnBoard ? 'w-auto h-auto' : ''} ${isClickable && 'cursor-pointer hover:shadow-lg'} ${attackClassName} ${isStunned || isHidden ? 'opacity-70' : ''} ${didAct ? 'rotate-90 opacity-50' : ''}`}
      style={
        isClickable
